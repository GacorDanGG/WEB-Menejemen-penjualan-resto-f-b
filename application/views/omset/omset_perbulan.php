...
<div class="flex-grow-1 p-4" style="background-color: #f8f9fa;">
    ...
    <?php else: ?>
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            <h1 class="h3 mb-0" style="color: #333;">Omset Per Bulan</h1>
        </div>
        ...
        <div class="card" style="border-radius: 10px; box-shadow: 0 0.15rem 1.75rem 0 rgba(58, 59, 69, 0.15); border: none;">
            <div class="card-header bg-white py-3" style="border-bottom: 1px solid #e3e6f0;">
                <h6 class="m-0 font-weight-bold" style="color: #dc3545;">Detail Omset Per Bulan</h6>
            </div>
            <div class="card-body">
                    ...
                    <table class="table table-hover mb-0">
                        <thead>
                            <tr style="background-color: #f8f9fc;">
                                <th class="py-3" style="border-top: none;">Bulan</th>
                                <th class="py-3" style="border-top: none;">Total Omset</th>
                            </tr>
                        </thead>
                        <tbody>
                            <?php if (!empty($omset_perbulan)) : ?>
                                <?php foreach ($omset_perbulan as $row) : ?>
                                    <tr>
                                        <td class="py-3"><?= htmlspecialchars($row['bulan']); ?></td>
                                        <td class="py-3 font-weight-bold">Rp <?= number_format($row['total_omset'], 0, ',', '.'); ?></td>
                                    </tr>
                                <?php endforeach; ?>
                            <?php else : ?>
                                <tr>
